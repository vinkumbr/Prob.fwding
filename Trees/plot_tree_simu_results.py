...
ax1.plot(n,pkndelta_1,'--', label='$\delta = 0.1$')
ax1.plot(n,pkndelta_05,'g-', label='$\delta = 0.05$')
...
ax2.plot(n,taukndelta_1,'--', label='$\delta = 0.1$')
ax2.plot(n,taukndelta_05,'g-', label='$\delta = 0.05$')
