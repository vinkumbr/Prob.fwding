...
#averaged over 100 realizations of the RGG and 100 probabilistic forwarding protocol iterations for each graph from single_pkt_receivers_formula_verify.py
...
recs_ergodic = [m**2*lbda*theta_lbda_p_square[i] for i in range(len(lbda_p))]

fig,ax = plt.subplots(1,1)
fig.suptitle('For an RGG in a 101 by 101 grid with connection radius =1 and intensity 4.5.')
ax.plot(p,recs_ergodic,"o",label='ergodic estimate of receivers')
