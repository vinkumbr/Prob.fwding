...
#Results of running prob_fwding_parallel_recs_avg.py on RGG with M given by ./AdjMats/comp_origin/*.txt with m=101, lambda=4 and radius=1. 20 realizations of RGG and 10 prob forwarding on each. Graph consists of component of the origin
pkndelta_simu1= [0.55,0.49,0.46,0.438,0.426,0.4195,0.4116,0.406,0.402,0.399,0.3958,0.3936,0.3919,
0.3898,0.38830,0.3864,0.385,0.3839,0.3829,0.3819,0.38100]

tau_kndelta_simu1=[445910.16, 411001.01, 397756.945, 386174.745, 381840.235, 388367.705, 387463.145, 387430.885, 391329.725, 392842.31, 396894.535, 402186.86, 404928.765, 408568.56, 415804.82, 413514.12, 417665.23, 421950.91, 428217.495, 428126.895, 432020.37]
...
if lbda == 4.5:
	pkndelta_simu = [0.52,0.445,0.415,0.399,0.39,0.378,0.3704,0.3654,0.361,0.3584,0.355,0.3528, 0.3507,0.3490,0.3476,0.3464,0.345,0.3435,0.34270,0.3417,0.34060]
	tau_kndelta_simu=[474206.03, 418039.03, 400892.805, 395671.405, 396795.23, 390854.84, 389462.235, 391848.53, 392216.645, 395024.78, 395464.015, 400058.84, 404025.82, 404915.225, 411185.47, 415250.9, 416403.155, 416166.83, 417901.64, 426683.235, 425471.965]
